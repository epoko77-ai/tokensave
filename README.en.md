...
[![한국어 README](https://img.shields.io/badge/README-한국어-red)](README.md)

> 🇰🇷 **한국어 버전:** [README.md](README.md) — Korean is the primary README; this file is the English mirror.
...
- **Korean is the primary user-facing language.** README.md is Korean (this file, README.en.md, is the English mirror). SKILL.md is Korean — the catalog was built by a Korean operator for Korean Claude Code users. `references/taxonomy.md` is Korean (the 220-line, 10-category × 31-pattern catalog); other `references/` files (matrices, anti-patterns, hook examples) are English so that downloadable artifacts remain useful to both audiences.
